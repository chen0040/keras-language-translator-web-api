...
class EngToFraCharTranslator(object):
    ...
    def __init__(self):
        self.input_char2idx = np.load('../translator_train/models/eng-to-fra-char-input-char2idx.npy').item()
        self.input_idx2char = np.load('../translator_train/models/eng-to-fra-char-input-idx2char.npy').item()
        self.target_char2idx = np.load('../translator_train/models/eng-to-fra-char-target-char2idx.npy').item()
        self.target_idx2char = np.load('../translator_train/models/eng-to-fra-char-target-idx2char.npy').item()
        context = np.load('../translator_train/models/eng-to-fra-char-context.npy').item()
        ...
        # model_json = open('../translator_train/models/eng-to-fra-char-architecture.json', 'r').read()
        # self.model = model_from_json(model_json)
        self.model.load_weights('../translator_train/models/eng-to-fra-char-weights.h5')
