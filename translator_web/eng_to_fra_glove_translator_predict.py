...
class EngToFraGloveTranslator(object):
    ...
    def __init__(self):
        ...
        self.target_word2idx = np.load(
            '../translator_train/models/eng-to-fra/eng-to-fra-word-target-word2idx.npy').item()
        self.target_idx2word = np.load(
            '../translator_train/models/eng-to-fra/eng-to-fra-word-target-idx2word.npy').item()
